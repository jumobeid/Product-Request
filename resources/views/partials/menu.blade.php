<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('basic_c_r_m_access')
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('purchased_item_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.purchased-items.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/purchased-items") || request()->is("admin/purchased-items/*") ? "active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.purchasedItem.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('pending_invoice_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.pending-invoices.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/pending-invoices") || request()->is("admin/pending-invoices/*") ? "active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.pendingInvoice.title') }}
                </a>
            </li>
        @endcan
        @can('packing_slip_detail_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.packing-slip-details.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/packing-slip-details") || request()->is("admin/packing-slip-details/*") ? "active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.packingSlipDetail.title') }}
                </a>
            </li>
        @endcan
        @can('packing_slip_item_detail_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.packing-slip-item-details.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/packing-slip-item-details") || request()->is("admin/packing-slip-item-details/*") ? "active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.packingSlipItemDetail.title') }}
                </a>
            </li>
        @endcan
