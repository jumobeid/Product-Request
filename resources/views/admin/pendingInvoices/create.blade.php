...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pendingInvoice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pending-invoices.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pending_invoice_total_amount') ? 'is-invalid' : '' }}" type="number" name="pending_invoice_total_amount" id="pending_invoice_total_amount" value="{{ old('pending_invoice_total_amount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('invoice_due_date') ? 'is-invalid' : '' }}" type="text" name="invoice_due_date" id="invoice_due_date" value="{{ old('invoice_due_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_code') ? 'is-invalid' : '' }}" type="number" name="discount_code" id="discount_code" value="{{ old('discount_code', '') }}" step="1">
